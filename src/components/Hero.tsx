...
const tabs = [
  { name: 'cypress.config.ts', isActive: true },
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Let AI debug your cypress test failures, right as they happen.
                Providing quality test failure summaries and next steps for
                resolving.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/installation">Get started</Button>
                <Button
                  href="https://github.com/djgould/cypress-ai"
                  variant="secondary"
                >
                  View on GitHub
                </Button>
